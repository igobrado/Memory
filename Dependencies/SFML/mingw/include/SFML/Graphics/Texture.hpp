...
public:
    ...
    ///
    /// No additional check is performed on the size of the pixel
    /// array or the bounds of the area to handleInput, passing invalid
...
/// to the texture in a single operation (see Texture::handleInput).
///
...
///     ...
///
///     // handleInput the texture
///     sf::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
///     texture.handleInput(pixels);
///
///     // draw it
///     window.draw(sprite);
///
