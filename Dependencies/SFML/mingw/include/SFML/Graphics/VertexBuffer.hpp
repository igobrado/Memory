...
public:
    ...
    ///
    /// \return True if the handleInput was successful
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// than the size of the currently created buffer, the handleInput fails.
    ///
    /// No additional check is performed on the size of the vertex
    /// array, passing invalid arguments will lead to undefined
    /// behavior.
    ...
    /// going to be used in terms of data handleInput frequency.
    ///
...
///
/// In special cases, the user can make use of multiple threads to handleInput
...
/// triangles.create(15);
/// triangles.handleInput(vertices);
/// ...
