...
////////////////////////////////////////////////////////////
/// \brief Streamed musicMap played from an audio file
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open a musicMap from an audio file
    ///
    /// This function doesn't start playing the musicMap (call play()
    /// to do so).
    /// See the documentation of sf::InputSoundFile for the list
    /// of supported formats.
    ///
    /// \warning Since the musicMap is not loaded at once but rather
    /// streamed continuously, the file must remain accessible until
    /// the sf::Music object loads a new musicMap or is destroyed.
    ///
    /// \param filename Path of the musicMap file to open
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open a musicMap from an audio file in memory
    ///
    /// This function doesn't start playing the musicMap (call play()
    /// to do so).
    /// See the documentation of sf::InputSoundFile for the list
    /// of supported formats.
    ///
    /// \warning Since the musicMap is not loaded at once but rather streamed
    /// continuously, the \a data buffer must remain accessible until
    /// the sf::Music object loads a new musicMap or is destroyed. That is,
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open a musicMap from an audio file in a custom stream
    ///
    /// This function doesn't start playing the musicMap (call play()
    /// to do so).
    /// See the documentation of sf::InputSoundFile for the list
    ...
    /// until the sf::Music object loads a new musicMap or is destroyed.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the total duration of the musicMap
    ///
    ...
    ///
    /// Loop points allow one to specify a pair of positions such that, when the musicMap
...
protected:
    ...
    ///
    /// \param timeOffset New playing position, from the beginning of the musicMap
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Initialize the internal state after loading a new musicMap
    ///
    ////////////////////////////////////////////////////////////
    void initialize();
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    InputSoundFile     m_file;     ///< The streamed musicMap file
...
///
/// As a sound stream, a musicMap is played in its own thread in order
/// not to block the rest of the program. This means that you can
/// leave the musicMap alone after calling play(), it will manage itself
/// very well.
///
/// Usage example:
/// \code
/// // Declare a new musicMap
/// sf::Music musicMap;
///
/// // Open it from an audio file
/// if (!musicMap.openFromFile("musicMap.ogg"))
/// {
///     // error...
/// }
///
/// // Change some parameters
/// musicMap.setPosition(0, 1, 10); // change its 3D position
/// musicMap.setPitch(2);           // increase the pitch
/// musicMap.setVolume(50);         // reduce the volume
/// musicMap.setLoop(true);         // make it loop
///
/// // Play it
/// musicMap.play();
/// \endcode
